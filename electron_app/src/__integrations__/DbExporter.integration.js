...
const insertLabels = async params => {
  return await DBManager.createLabel(params.map( label => {
...
describe('Encrypt and Decrypt: ', () => {
  ...
  it('Should save database to file: ', async () => {
    ...
    const sampleFile = fs.readFileSync(PARSED_SAMPLE_FILEPATH, 'utf8');
    const resultFile = fs.readFileSync(outputPath, 'utf8');
