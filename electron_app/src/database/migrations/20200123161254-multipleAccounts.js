  ...
  if (settingsDef.autoBackupEnable !== undefined) {
    ...
    if (settings && settings.autoBackupEnable && account) {
      queryInterface.sequelize.query(
        ...
        }, autoBackupNextDate=${settings.autoBackupNextDate}, autoBackupPath=${
...
const rollbackAccountSettings = async (
  ...
  if (account && account.autoBackupEnable && settings) {
    queryInterface.sequelize.query(
      ...
      }, autoBackupLastSize=${account.autoBackupLastSize}, autoBackupNextDate=${
        account.autoBackupNextDate
      }, autoBackupPath=${account.autoBackupPath}, autoBackupLastDate=${
        account.autoBackupLastDate
